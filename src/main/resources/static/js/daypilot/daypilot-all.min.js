/**
 * @license DayPilot Pro for JavaScript 2020.4.4766 (trial) Copyright (c) 2005 -
 *          2020 Annpoint s.r.o. https://www.daypilot.org/ Use of this software
 *          is subject to license terms.
 */
if("undefined"==typeof DayPilot)
	var DayPilot={};
if("undefined"==typeof DayPilot.Global&&(DayPilot.Global={})
		,function(DayPilot){function e(e){
			...
			var r=n.getUTCSeconds();r<10&&(r="0"+r);
			var o=n.getUTCMinutes();o<10&&(o="0"+o);
			var s=n.getUTCHours();s<10&&(s="0"+s);
			var l=n.getUTCDate();l<10&&(l="0"+l);
			var d=n.getUTCMonth()+1;d<10&&(d="0"+d);
			var c=n.getUTCFullYear();
			if(c<=0)
				throw"The minimum year supported is 1.";c<10?c="000"+c:c<100?c="00"+c:c<1e3&&(c="0"+c);
		...
		function t(e,t){
					...
					return document.getElementById(e)
						...
						if("undefined"!=typeof t.offsetX){
							...
							for(var n=t.srcElement;n&&n!==e;)
								"SPAN"!==n.tagName&&(i.x+=n.offsetLeft,n.offsetTop>0&&(i.y+=n.offsetTop-n.scrollTop)),n=n.offsetParent;
					return n?i:null
							}
			...
			if(!e)
				return i;
			for(var n=t.target;n&&"absolute"!==n.style.position&&"relative"!==n.style.position;)
				n=n.parentNode,DayPilot.isKhtml&&(i.y+=n.scrollTop);
			for(;n&&n!==e;)
				i.x+=n.offsetLeft,i.y+=n.offsetTop-n.scrollTop,n=n.offsetParent;
			return n?i:null
					}
			return null
